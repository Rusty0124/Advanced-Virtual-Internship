import { useActiveStatistic } from "../../hooks/useActiveStatistic";

export default function Statistics() {
  const firstWrapperRef = useActiveStatistic();
  const secondWrapperRef = useActiveStatistic();
  return (
    <>
      <div className="statistics__wrapper" ref={firstWrapperRef}>
